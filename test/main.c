...
static void test_klciph()
{
	...
	uint8_t plain2[256];
	int plen2;
	assert(klciph_dec(NULL, clen, plain2, &plen2) == FAIL);
	assert(klciph_dec(cipher, 0, plain2, &plen2) == FAIL);
	assert(klciph_dec(cipher, 1, plain2, &plen2) == FAIL);
	assert(klciph_dec(cipher, 128, plain2, &plen2) == FAIL);
	assert(klciph_dec(cipher, 255, plain2, &plen2) == FAIL);
	assert(klciph_dec(cipher, 256, plain2, &plen2) == SUCC);
	assert(klciph_dec(cipher, clen, NULL, &plen2) == FAIL);
	assert(klciph_dec(cipher, clen, plain2, NULL) == FAIL);
